...
export function registerProductCompiler(
  ...
  pi.registerTool(defineTool({
    ...
    promptGuidelines: [
      ...
      "A standings entry already makes each participant field a dropdown of the row entity's existing records and blocks a record whose two participants are the same. Never restate 'populate the team options from existing teams', 'pick from the entered teams', or 'a team must not play itself' as a customRequirement — the runtime enforces both.",
