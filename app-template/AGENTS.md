...
- The seed includes a configuration-driven product journey test. Extend it only when focused custom behavior introduces a new observable journey; the runner rejects zero-test reports and any skipped or todo tests.
